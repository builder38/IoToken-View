...
const Mapper = () => { 
    ...
    //smart account
    const wallet = XRPL.Wallet.fromSeed("sEdVHRTB6RoArSFDRVCaXuG7szRFAUB");
    ...
    const aliases = {
        schemas: {
            PointGeometrySchema: 'ceramic://k3y52l7qbv1frxwokbejz71l8h61np1oufwdj0i9daspbjuvdoiprpncvutaq0uf4',
        },
        definitions: {
            PointGeometryDefinition: 'kjzl6cwe1jw145ku49n0v39ubber5pfv32b70e20j80y64q4tnpa3l8u05l0g3p',
        },
        tiles: {},
    }
    ...
    function smartOblique(txs){
       ...
       //const lay = document.getElementById('menu');
       //lay.removeChild(document.getElementById('a')); 
    ...
    //loads sphere or test load depending on user choice in dropdown
        ...
        map.on('load', () => { 
            ...
            map.on('click', function(e) {
                ...
                new mapboxgl.Popup()
                    ...
                    .setHTML('<div><label style="color: teal;font-weight: 700;text-decoration: underline">Pointcloud IoT Network</label></div>' +
    ...
    function loadNetwork(){
        ...
        switch (document.getElementById("network").selectedIndex) {
            case 0:
                document.getElementById('mapdesc').hidden = true;
                document.getElementById("map").display = 'none'
                break;
            case 1:
                loadSensors();
...
return (
    ...
    <form className="sensor_form2" id="myform2">
        <div>
            <label style={{ position: "relative", top: "16px", width: "120px", left: "-100px", fontWeight: "bold" }}>IoT Network:</label>
            <select id="network" required onChange={loadNetwork} style={{ position: "relative", width: "198px", height: "25px", left: "60px", top: "-5px", color: "blue", fontSize: "17px", fontWeight: "bold" }}>
                <option value=""></option>
                <option value="Point Cloud IoT">Point Cloud IoT</option>
                <option value="Smart Building IoT">Smart Building IoT</option>
            </select>
    ...
    <form className="sensor_form" id="myform">
        ...
        <div>
            ...
            <button type="button" onClick={(e) => {window.open('https://testnet.xrpl.org/transactions/' + document.getElementById('xrplgate').value);}} style={{ position: "relative", top: "-29px", height: "20px", width: "20px", left: "44px", borderRadius: "5px"}}></button>
        </div>
        <div>
        ...
        <div>
            <label style={{ position: "relative", width: "135px", top: "-77px", left: "-126px", color: "blue", fontSize: "17px", fontWeight: "bold"}}>Sensors</label>
        </div>
        <div>
        ...
        <div>
            ...
            <button type="button" onClick={(e) => {window.open('https://testnet.xrpl.org/transactions/' + document.getElementById('xrplsensor').value);}}style={{ position: "absolute", bottom: "191px", height: "20px", width: "20px", right: "16px", borderRadius: "5px"}}></button>
        </div>
        <div>
