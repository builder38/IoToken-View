...
import { getResolver } from 'key-did-resolver';
 ...
 //smart account
 const wallet = XRPL.Wallet.fromSeed("sEdVd5eZ4BEBsocPHpV8xooiiFm9dua");
...
const aliases = {
    schemas: {
        PointGeometrySchema: 'ceramic://k3y52l7qbv1frxtqs8cpqce1b0h6y37w4l3gzwe297ao09kh6gvflykilgy8ultkw',
    },
    definitions: {
        PointGeometryDefinition: 'kjzl6cwe1jw148j0ezeh7hlbzhlbwbkr9ievwgwopv09srwozuuaspvgkj3vq70',
    },
    tiles: {},
}
...
const Tokenizer = (props) => {
    ...
    //    });   
       ...
       //TOKENIZE A SINGLE NEW SENSOR
       let tArray = [];
       tArray.push(parseFloat(document.getElementById('lngsensor').value));
       tArray.push(parseFloat(document.getElementById('latsensor').value));
       tArray.push(parseFloat(document.getElementById('elevsensor').value));
       let sensorData = {
           "hash": "x",
           "tokenid": "y",
    ...
    <>
    <div>
        <input type="radio" id="single" name="single" style={{ position: "absolute", top: "661px", right: "390px"}}defaultChecked></input>
        <label htmlFor="single" id="singlelabel" style={{ position: "absolute", top: "657px", right: "410px", fontSize: "13px"}}>Single</label>
        <input type="radio" id="batch" name="batch" style={{ position: "absolute", top: "661px", right: "330px"}}></input>
        <label htmlFor="batch" id="batchlabel" style={{ position: "absolute", top: "658px", right: "350px", fontSize: "13px"}}>Batch</label>
        <button id="add" onClick={tokenize} style={{ position: "absolute", top: "655px", height: "25px", width: "80px", left: "970px"}}>Add</button>
